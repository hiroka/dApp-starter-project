...
const App = () => {
  ...
  const contractAddress = "0xcD71F4C0bC4a245f91e37A1987ACF49611B97bD3";
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        <div className="bio">
          <p>1.イーサリアムウォレットを接続してください</p>
          <p>2.メッセージを作成してください</p>
          <p>3. <span role="img" aria-label="hand-wave">
            👋(wave)
          </span>
          を送ってください
